package org.Lab2.database.dao;

import org.Lab2.database.entity.User;
...
// Указывает, что аннотированный класс является "компонентом". Такие классы рассматриваются в качестве
// кандидатов для автоматического обнаружения при использовании сканирования конфигурации на основе аннотаций и classpath.
@Component

//область доступности для component
